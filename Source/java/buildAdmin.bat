...
"C:\Program Files\Java\jdk1.8.0_60\bin\javac" -source 1.7 -target 1.7 %VERBOSE_FLAG% -Xlint:deprecation -cp %ANDROID_PLATFORM%\android.jar -d output\classes src\com\kiosk\admin\AdminReceiver.java
...
"C:\Program Files\Java\jdk1.8.0_60\bin\jar" c%VERBOSE_FLAG%f output\jar\AdminReceiver_classes.jar -C output\classes com
 
echo.
echo Now we have the end result, which is output\jar\AdminReceiver_classes.jar
